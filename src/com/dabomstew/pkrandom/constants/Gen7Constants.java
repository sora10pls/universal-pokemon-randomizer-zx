...
public class Gen7Constants {
    ...
    public static final Map<Integer,Integer> balancedItemPrices = Stream.of(new Integer[][] {
            ...
            {Items.rustedSword, 1000},
            {Items.rustedShield, 1000},
            {Items.reinsofUnity, 1000},
            {Items.adamantCrystal, 1000},
            {Items.lustrousGlobe, 1000},
            {Items.wellspringMask, 1000},
            {Items.hearthflameMask, 1000},
            {Items.cornerstoneMask, 1000},
            {Items.galaricaCuff, 300},
            {Items.galaricaWreath, 300},
            {Items.tartApple, 300},
            {Items.sweetApple, 300},
            {Items.crackedPot, 300},
            {Items.chippedPot, 300},
            {Items.strawberrySweet, 300},
            {Items.berrySweet, 300},
            {Items.loveSweet, 300},
            {Items.starSweet, 300},
            ...
            {Items.clefablite, 500},
            {Items.victreebelite, 500},
            {Items.starminite, 500},
            {Items.dragoninite, 1000},
            {Items.meganiumite, 1000},
            {Items.feraligite, 1000},
            {Items.skarmorite, 1000},
            {Items.froslassite, 1000},
            {Items.emboarite, 1000},
            {Items.excadrite, 1000},
            {Items.scolipite, 1000},
            {Items.scraftinite, 1000},
            {Items.eelektrossite, 1000},
            {Items.chandelurite, 1000},
            {Items.chesnaughtite, 1000},
            {Items.delphoxite, 1000},
            {Items.pyroarite, 500},
            {Items.malamarite, 500},
            {Items.barbaracite, 500},
            {Items.dragalgite, 500},
            {Items.hawluchanite, 1000},
            {Items.drampanite, 500},
            {Items.falinksite, 1000},
            {Items.chimechite, 1000},
            {Items.staraptite, 1000},
            {Items.heatranite, 2000},
            {Items.darkranite, 2000},
