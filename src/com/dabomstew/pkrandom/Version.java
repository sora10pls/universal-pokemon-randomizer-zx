...
public class Version {
    public static final int VERSION = 326; // Increment by 1 for new version. Updated for 1.0.0-Expansion.
    public static final String VERSION_STRING = "1.1.0-Expansion";
    ...
    private static Map<Integer,String> setupVersionsMap() {
        ...
        map.put(321, "4.6.0");
        map.put(322, "4.6.1");
        map.put(323, "1.0.0-Expansion");
        map.put(324, "1.0.1-Expansion");
        map.put(325, "1.0.2-Expansion");
