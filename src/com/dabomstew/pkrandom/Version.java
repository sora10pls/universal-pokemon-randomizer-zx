...
public class Version {
    public static final int VERSION = 323; // Increment by 1 for new version. Updated for 1.0.0-Expansion.
    public static final String VERSION_STRING = "1.0.0-Expansion";
